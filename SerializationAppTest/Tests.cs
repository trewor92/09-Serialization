...
namespace SerializationAppTest
{
    ...
    public class Tests
    {
        ...
        private string ResourseFileName = Path.Combine(
                    Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName,"SerializationAppTest", "Resources", "GoogleSearchJson.txt");
        [TestMethod]
        ...
        [DataContract(Name = "Company", Namespace = "http://schemas.datacontract.org/2004/07/SerializationApp")]
        ...
        private string ResourseFileName2 = Path.Combine(
            Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, "SerializationAppTest", "Resources", "CLR-ETW.man");
        ...
        public void InstrumentationManifest_class_should_deserialized()
        {
            ...
            using (var stream = File.OpenRead(ResourseFileName2))
            {
